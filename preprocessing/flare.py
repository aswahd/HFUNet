# Code adapted from https://github.com/bowang-lab/MedSAM/blob/main/pre_CT_MR.py
...
nii_path = "/home/wahd/datasets/FLARE22Train/images"  # path to the nii images
gt_path = "/home/wahd/datasets/FLARE22Train/labels"  # path to the ground truth
npy_path = "/home/wahd/datasets/FLARE22/Test/" + prefix[:-1]
    ...
    if len(z_index) > 0:
        ...
        if modality == "CT":
            ...
            lower_bound, upper_bound = (
                np.percentile(image_data[image_data > 0], 0.5),
...
with multiprocessing.Pool() as pool:
    pool.map(process_data, names[40:])  # use the remaining 10 cases for validation
