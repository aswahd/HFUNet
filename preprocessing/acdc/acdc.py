...
if __name__ == '__main__':
    ...
    input_folder = '/home/wahd/datasets/ACDC/testing'
    preprocessing_folder = '/home/wahd/datasets/ACDCPreprocessed/testing'

    # d=load_and_maybe_process_data(input_folder, preprocessing_folder, '3D', (116,116,28), (2.5,2.5,5))
    d=load_and_maybe_process_data(input_folder, preprocessing_folder, '2D', (212,212), (1.36719, 1.36719), split_test_train=False)
